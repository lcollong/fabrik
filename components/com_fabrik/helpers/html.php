...
<?php
	...
	/**
	 * @deprecated - no longer supporting pdf rendering
	 */

	public static function PdfIcon($model, $params, $rowId = 0, $attribs = array())
	{
		$app = JFactory::getApplication();
		$url = '';
		$text	= '';
	...
	/**
	 * @deprecated intialised in Fabrik.tips
