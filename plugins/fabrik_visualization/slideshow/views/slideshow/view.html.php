...
class fabrikViewSlideshow extends JView
{
	...
	function display($tmpl = 'default')
	{
		...
		$tmplpath = $model->pathBase.'slideshow/views/slideshow/tmpl'. '/' .$tmpl;
		...
		$this->_setPath('template', JPATH_ROOT . '/plugins/fabrik_visualization/slideshow/views/slideshow/tmpl/' . $tmpl);
