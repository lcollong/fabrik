...
class plgFabrik_ElementDate extends plgFabrik_Element
{
	 ...
	 * @param	mixed	this elements posted form data
	...
	/**
	 * @see plgFabrik_Element::onAutocomplete_options()
	 */
	...
	/**
	 * add hours to a date
	 * @param	string	The initial time for the FabDate object
	 * @param	integer number of days to add (negtive to remove days)
	...
	/**
	* build the query for the sum caclculation
	* @param	model	$listModel
	* @param	string	$label the label to apply to each avg
	* @return	string	sql statement
	*/
	...
	/**
	 * (non-PHPdoc)
	 * @see plgFabrik_Element::simpleAvg()
	 */
	...
	{
		return (int)($date->format('H') * 60 * 60) + (int)($date->formt('i') * 60) + (int)$date->format('s');
	}
